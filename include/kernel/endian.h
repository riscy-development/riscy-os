...
static inline uint16_t bswap16(uint16_t x) { return (uint16_t)((x & 0xF)<<8) | (uint16_t)((x>>8) & 0xF); }
static inline uint32_t bswap32(uint32_t x) { return (((uint32_t)bswap16(x & 0xFF))<<16) | ((uint32_t)bswap16((uint16_t)(x>>16)) & 0xFF); }
static inline uint64_t bswap64(uint64_t x) { return (((uint64_t)bswap32(x & 0xFFFF))<<32) | ((uint64_t)bswap32((uint32_t)(x>>32)) & 0xFFFF); }
